  ...
  return (
    <article className="group cursor-pointer h-full flex flex-col">
      ...
      <div className="flex flex-col gap-2 text-center shrink-0">
        ...
        <h3 className="font-headline text-xl md:text-base lg:text-lg font-medium text-revista-black leading-tight group-hover:text-revista-gold transition-colors line-clamp-2">
          {article.title}
        </h3>
